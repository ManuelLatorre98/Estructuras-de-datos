...
public class TestBinario {
   ...
   public static final String RESET = "\u001B[0m";
	...
	System.out.println("Altura de arbol clon:  "+b.altura());
        ...
        System.out.println("Ancestros de 3.\n Tiene que dar: [9 10]     "+a.obtenerAncestros(3).toString());
        System.out.println("\n");
        System.out.println("Ancestros de 12.\n Tiene que dar: [15 10]     "+a.obtenerAncestros(12).toString());
        System.out.println("\n");
        System.out.println("Ancestros de raíz.\n Tiene que dar: [Lista vacía]     "+a.obtenerAncestros(10).toString());
        System.out.println("\n");
    }
